...
public class TestGetDiff extends TestSetUpGit {
	...
	public void testRevCommitExisting() {
		Diff diff = gitClient.getDiffForJiraIssueOnDefaultBranchesAndFeatureBranches(mockJiraIssueForGitTests);
	...
	public void testJiraIssueNull() {
		Diff diff = gitClient.getDiffForJiraIssueOnDefaultBranchesAndFeatureBranches((Issue) null);
		assertTrue(diff.getChangedFiles().isEmpty());
	}

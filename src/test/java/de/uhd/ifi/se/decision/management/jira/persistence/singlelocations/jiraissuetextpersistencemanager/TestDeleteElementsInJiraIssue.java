...
public class TestDeleteElementsInJiraIssue extends TestSetUp {
	...
	public void testJiraIssueNull() {
		assertFalse(manager.deleteElementsInJiraIssue(null));
	}
	...
	public void testCommentFilledAndElementsInDatabase() {
		...
		assertTrue(manager.deleteElementsInJiraIssue(sentence.getJiraIssue()));
	}
}

...
public class TestUpdateDecisionKnowledgeElementWithoutStatusChange extends TestJiraIssueCommentPersistenceManagerSetUp {

	@Test
	@NonTransactional
	public void testUpdateKnowledgeTypeSentenceNull() {
		assertFalse(new JiraIssueTextPersistenceManager("").updateDecisionKnowledgeElementWithoutStatusChange(null, null));
	}
	...
	public void testUpdateKnowledgeTypeSentenceElementNull() {
		...
		sentence.setId(1000);
		assertFalse(new JiraIssueTextPersistenceManager("").updateDecisionKnowledgeElementWithoutStatusChange(sentence, null));
	}

...
public class TestGetBranchMetrics extends TestSetUp {
	...
	public void testRequestValidFilterSettingsValid() {
		Response response = dashboardRest.getBranchMetrics(request, filterSettings);
		assertEquals(Response.Status.OK.getStatusCode(), response.getStatus());
	}

	@Test
	public void testRequestValidFilterSettingsNull() {
		Response response = dashboardRest.getBranchMetrics(request, null);
		assertEquals(Response.Status.BAD_REQUEST.getStatusCode(), response.getStatus());
	}

	@Test
	public void testRequestNullFilterSettingsValid() {
		Response response = dashboardRest.getBranchMetrics(null, filterSettings);
		assertEquals(Response.Status.BAD_REQUEST.getStatusCode(), response.getStatus());
	}
}

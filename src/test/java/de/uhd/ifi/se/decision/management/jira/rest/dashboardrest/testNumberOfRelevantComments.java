...
public class testNumberOfRelevantComments extends TestSetUpGit {
	...
	public void testRequestNull() {
		...
		assertEquals(Status.BAD_REQUEST.getStatusCode(),
			dashboardRest.getNumberOfRelevantComments(null, null).getStatus());
	}
	...
	public void testIssueKeyNull() {
		ConfigPersistenceManager.setKnowledgeExtractedFromGit("", true);
		assertEquals(Status.BAD_REQUEST.getStatusCode(),
			dashboardRest.getNumberOfRelevantComments(request, null).getStatus());
	}
	...
	public void testEmptyIssueKey() {
		ConfigPersistenceManager.setKnowledgeExtractedFromGit("", true);
		assertEquals(Status.BAD_REQUEST.getStatusCode(),
			dashboardRest.getNumberOfRelevantComments(request, "").getStatus());
	}

	@Test
	public void testUnknownIssueKey() {
		assertEquals(Status.BAD_REQUEST.getStatusCode(),
			dashboardRest.getNumberOfRelevantComments(request, "HOUDINI-1").getStatus());
	}
	...
	public void testGitExtractionDisabled() {
		...
		assertEquals(Status.SERVICE_UNAVAILABLE.getStatusCode(),
			dashboardRest.getNumberOfRelevantComments(request, "TEST-2").getStatus());

...
public class TestArgumentKnowledgeElementCompletenessCheck extends TestSetUp {
	...
	public void testIsLinkedToDecision() {
		...
		assertTrue(new ArgumentKnowledgeElementCompletenessCheck().execute(proArgument));
	}
	...
	public void testIsNotLinkedToDecision() {
		...
		assertFalse(new ArgumentKnowledgeElementCompletenessCheck().execute(proArgument));
	}
}

...
public class testDistributionOfKnowledgeTypes extends TestSetUpGit {
	...
	public void testRequestNull() {
		...
		assertEquals(Status.BAD_REQUEST.getStatusCode(),
			dashboardRest.getDistributionOfKnowledgeTypes(null, null).getStatus());
	}
	...
	public void testIssueKeyNull() {
		ConfigPersistenceManager.setKnowledgeExtractedFromGit("", true);
		assertEquals(Status.BAD_REQUEST.getStatusCode(),
			dashboardRest.getDistributionOfKnowledgeTypes(request, null).getStatus());
	}
	...
	public void testEmptyIssueKey() {
		ConfigPersistenceManager.setKnowledgeExtractedFromGit("", true);
		assertEquals(Status.BAD_REQUEST.getStatusCode(),
			dashboardRest.getDistributionOfKnowledgeTypes(request, "").getStatus());
	}

	@Test
	public void testUnknownIssueKey() {
		assertEquals(Status.BAD_REQUEST.getStatusCode(),
			dashboardRest.getDistributionOfKnowledgeTypes(request, "HOUDINI-1").getStatus());
	}
	...
	public void testGitExtractionDisabled() {
		...
		assertEquals(Status.SERVICE_UNAVAILABLE.getStatusCode(),
			dashboardRest.getDistributionOfKnowledgeTypes(request, "TEST-2").getStatus());

...
public class TestDecisionKnowledgeElementCompletenessCheck extends TestSetUp {
	...
	public void testIsLinkedToIssue() {
		...
		assertTrue(new DecisionKnowledgeElementCompletenessCheck().execute(decision));
	}
	...
	public void testIsNotLinkedToIssue() {
		...
		assertFalse(new DecisionKnowledgeElementCompletenessCheck().execute(decision));
	}
}

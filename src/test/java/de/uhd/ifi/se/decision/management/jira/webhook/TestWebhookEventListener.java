...
public class TestWebhookEventListener extends TestSetUpWithIssues {
    ...
    public void testIssueCreated(){
        IssueEvent event = new IssueEvent(issue, user, jiraComment, null, new MockGenericValue("test"), new HashMap<String, String>(),
    ...
    public void testIssueLinkCreated(){
        IssueLink link = new MockIssueLink((long)1);

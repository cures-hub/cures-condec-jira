...
public class testNumberOfElementsPerDocumentationLocation extends TestSetUpGit {
	...
	public void testRequestNull() {
		...
		assertEquals(Status.BAD_REQUEST.getStatusCode(),
			dashboardRest.getNumberOfElementsPerDocumentationLocation(null, null).getStatus());
	}
	...
	public void testIssueKeyNull() {
		ConfigPersistenceManager.setKnowledgeExtractedFromGit("", true);
		assertEquals(Status.BAD_REQUEST.getStatusCode(),
			dashboardRest.getNumberOfElementsPerDocumentationLocation(request, null).getStatus());
	}
	...
	public void testEmptyIssueKey() {
		ConfigPersistenceManager.setKnowledgeExtractedFromGit("", true);
		assertEquals(Status.BAD_REQUEST.getStatusCode(),
			dashboardRest.getNumberOfElementsPerDocumentationLocation(request, "").getStatus());
	}

	@Test
	public void testUnknownIssueKey() {
		assertEquals(Status.BAD_REQUEST.getStatusCode(),
			dashboardRest.getNumberOfElementsPerDocumentationLocation(request, "HOUDINI-1").getStatus());
	}
	...
	public void testGitExtractionDisabled() {
		...
		assertEquals(Status.SERVICE_UNAVAILABLE.getStatusCode(),
			dashboardRest.getNumberOfElementsPerDocumentationLocation(request, "TEST-2").getStatus());

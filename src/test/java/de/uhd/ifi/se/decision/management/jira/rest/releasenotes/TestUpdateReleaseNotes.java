...
public class TestUpdateReleaseNotes extends TestSetUp {
	...
	public void testRequestValidReleaseNotesNotInDatabase() {
		assertEquals(Status.BAD_REQUEST.getStatusCode(),
				releaseNotesRest.updateReleaseNotes(request, releaseNotes).getStatus());
	}
	...
	public void testRequestValidReleaseNotesValid() {
		...
		assertEquals(Status.OK.getStatusCode(), releaseNotesRest.updateReleaseNotes(request, releaseNotes).getStatus());
	}
}

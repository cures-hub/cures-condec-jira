...
public class TestBranchDiff {
	...
	private DecisionKnowledgeElement rat1 = new DecisionKnowledgeElementImpl(0
			, "I am an issue", "", KnowledgeType.ISSUE, "TEST"
			, "file.java 1 INSERT(0-0,0-10) 1:2:3 abcdef01", DocumentationLocation.COMMIT
	);
	private DecisionKnowledgeElement rat2 = new DecisionKnowledgeElementImpl(0
			, "I am an issue too", "", KnowledgeType.ISSUE, "TEST"
			, "012345678901234567890123456789012345678a 1:1 abcdef23", DocumentationLocation.COMMIT
	);
	private DecisionKnowledgeElement rat3 = new DecisionKnowledgeElementImpl(0
			, "I am an old issue", "", KnowledgeType.ISSUE, "TEST"
			, "~file.java 1 REPLACE(1-4,1-2) 1:2:3 abcdef45", DocumentationLocation.COMMIT
	);

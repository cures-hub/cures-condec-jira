...
public class MockAvatarManager implements AvatarManager {
    ...
    @Nonnull
    @Override
    public Avatar create(Avatar.Type type, @Nonnull String s, @Nonnull AvatarImageDataProvider avatarImageDataProvider) throws IOException {
        return null;
    }

    @Nonnull
    @Override
    public Avatar create(@Nonnull IconType iconType, @Nonnull IconOwningObjectId iconOwningObjectId, @Nonnull AvatarImageDataProvider avatarImageDataProvider) throws IOException {
        return null;
    }

    @Nonnull
    @Override
    public Avatar create(String s, String s1, IconType iconType, IconOwningObjectId iconOwningObjectId, InputStream inputStream, Selection selection) throws DataAccessException, IOException {
        return null;
    }

    @Nonnull
    @Override
    public Avatar create(String s, String s1, Project project, InputStream inputStream, Selection selection) throws DataAccessException, IOException {
        return null;
    }

    @Nonnull
    @Override
    public Avatar create(String s, String s1, ApplicationUser applicationUser, InputStream inputStream, Selection selection) throws DataAccessException, IOException {
        return null;
    }
    ...
    @Override
    public void readAvatarData(@Nonnull Avatar avatar, @Nonnull Avatar.Size size, @Nonnull Consumer<InputStream> consumer) throws IOException {
    ...
    @Override
    public boolean userCanCreateFor(@Nullable ApplicationUser applicationUser, @Nonnull IconType iconType, @Nonnull IconOwningObjectId iconOwningObjectId) {
        return false;
    }
}

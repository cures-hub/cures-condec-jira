...
public class TestGetCommits extends TestSetUpGit {
	...
	public void testJiraIssue() {
		List<RevCommit> commits = gitClient.getDiffForJiraIssueOnDefaultBranchesAndBranchesWithName(mockJiraIssueForGitTests).getCommits();
	...
	public void testJiraIssueNull() {
		List<RevCommit> commits = gitClient.getDiffForJiraIssueOnDefaultBranchesAndBranchesWithName((Issue) null).getCommits();

...
public class TestGetElementsForIssueWithType extends TestJiraIssueCommentPersistenceManagerSetUp {
	...
	public void testIdLessSProjectKeyNullTypeNull() {
		assertEquals(0, JiraIssueCommentPersistenceManager.getElementsForJiraIssueWithType(-1, null, null).size());
	}

	@Test
	@NonTransactional
	public void testIdZeroSProjectKeyNullTypeNull() {
		assertEquals(0, JiraIssueCommentPersistenceManager.getElementsForJiraIssueWithType(0, null, null).size());
	}
	...
	public void testIdLessSProjectKeyFilledTypeNull() {
		assertEquals(0, JiraIssueCommentPersistenceManager.getElementsForJiraIssueWithType(-1, "TEST", null).size());
	}

	@Test
	@NonTransactional
	public void testIdZeroSProjectKeyFilledTypeNull() {
		assertEquals(0, JiraIssueCommentPersistenceManager.getElementsForJiraIssueWithType(0, "TEST", null).size());
	}
	...
	public void testIdLessSProjectKeyNullTypeFilled() {
		assertEquals(0, JiraIssueCommentPersistenceManager.getElementsForJiraIssueWithType(-1, null, "decision").size());
	}

	@Test
	@NonTransactional
	public void testIdZeroSProjectKeyNullTypeFilled() {
		assertEquals(0, JiraIssueCommentPersistenceManager.getElementsForJiraIssueWithType(0, null, "decision").size());
	}
	...
	public void testIdLessSProjectKeyFilledTypeFilled() {
		assertEquals(0, JiraIssueCommentPersistenceManager.getElementsForJiraIssueWithType(-1, "TEST", "decision").size());
	}

	@Test
	@NonTransactional
	public void testIdZeroSProjectKeyFilledTypeFilled() {
		assertEquals(0, JiraIssueCommentPersistenceManager.getElementsForJiraIssueWithType(0, "TEST", "decision").size());
	}

...
public class TestPutLink extends TestSetUp {
	...
	public void testactionTypeNullKeyNullReqNullLinkNull() {
		assertEquals(Response.status(Status.BAD_REQUEST).entity(ImmutableMap.of("error", CREATION_ERROR)).build()
				.getEntity(), decRest.createLink(null, null, null).getEntity());
	}
	...
	public void testactionTypeNullKeyNullReqFilledLinkNull() {
		assertEquals(Response.status(Status.BAD_REQUEST).entity(ImmutableMap.of("error", CREATION_ERROR)).build()
				.getEntity(), decRest.createLink(null, req, null).getEntity());
	}
	...
	public void testactionTypeCreateKeyNullReqNullLinkNull() {
		assertEquals(Response.status(Status.BAD_REQUEST).entity(ImmutableMap.of("error", CREATION_ERROR)).build()
				.getEntity(), decRest.createLink("create", null, null).getEntity());
	}
	...
	public void testactionTypeCreateKeyNullReqFilledLinkNull() {
		assertEquals(Response.status(Status.BAD_REQUEST).entity(ImmutableMap.of("error", CREATION_ERROR)).build()
				.getEntity(), decRest.createLink("create", req, null).getEntity());
	}
	...
	public void testactionTypeNotCreateKeyNullReqNullLinkNull() {
		assertEquals(Response.status(Status.BAD_REQUEST).entity(ImmutableMap.of("error", CREATION_ERROR)).build()
				.getEntity(), decRest.createLink("notCreate", null, null).getEntity());
	}
	...
	public void testactionTypeNotCreateKeyNullReqFilledLinkNull() {
		assertEquals(Response.status(Status.BAD_REQUEST).entity(ImmutableMap.of("error", CREATION_ERROR)).build()
				.getEntity(), decRest.createLink("notCreate", req, null).getEntity());
	}

...
public class testNumberOfCommitsPerJiraIssue extends TestSetUpGit {
	...
	public void testRequestNull() {
		...
		assertEquals(Status.BAD_REQUEST.getStatusCode(),
			dashboardRest.getNumberOfCommitsPerJiraIssue(null, null).getStatus());
	}
	...
	public void testIssueKeyNull() {
		ConfigPersistenceManager.setKnowledgeExtractedFromGit("", true);
		assertEquals(Status.BAD_REQUEST.getStatusCode(),
			dashboardRest.getNumberOfCommitsPerJiraIssue(request, null).getStatus());
	}
	...
	public void testEmptyIssueKey() {
		ConfigPersistenceManager.setKnowledgeExtractedFromGit("", true);
		assertEquals(Status.BAD_REQUEST.getStatusCode(),
			dashboardRest.getNumberOfCommitsPerJiraIssue(request, "").getStatus());
	}

	@Test
	public void testUnknownIssueKey() {
		assertEquals(Status.BAD_REQUEST.getStatusCode(),
			dashboardRest.getNumberOfCommitsPerJiraIssue(request, "HOUDINI-1").getStatus());
	}

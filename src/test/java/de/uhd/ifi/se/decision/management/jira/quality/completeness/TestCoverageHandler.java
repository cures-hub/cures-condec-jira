...
public class TestCoverageHandler extends TestSetUp {
	...
	public void testCoverageHandlerDoesNotHaveMinimumCoverageTrue() {
		assertTrue(CoverageHandler.doesNotHaveMinimumCoverage(KnowledgeElements.getTestKnowledgeElement(),
	...
	public void testCoverageHandlerDoesNotHaveMinimumCoverageFalse() {
		assertFalse(CoverageHandler.doesNotHaveMinimumCoverage(KnowledgeElements.getTestKnowledgeElement(),

...
public class TestCommentSplitter extends TestSetUpWithIssues {
	...
	public static List<PartOfComment> getSentencesForCommentText(String text) {
	...
	public void testCommentWithTwoSentences() {
		List<PartOfComment> sentences = getSentencesForCommentText("This is a test Sentence. With two sentences");
	...
	public void testCommentWithOneQuote() {
		List<PartOfComment> sentences = getSentencesForCommentText(
	...
	public void testCommentWithTwoQuotes() {
		List<PartOfComment> sentences = getSentencesForCommentText("{quote} this is a quote {quote} "
	...
	public void testSentenceSplitWithNoformats() {
		List<PartOfComment> sentences = getSentencesForCommentText("{noformat} this is a noformat {noformat} "

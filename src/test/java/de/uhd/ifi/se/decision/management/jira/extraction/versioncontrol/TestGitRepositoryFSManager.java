...
public class TestGitRepositoryFSManager {
	...
	public void testReleaseBranchDirectoryNameToTemp() {
		...
		System.out.println("New File: " + new File(expectedBaseProjectUriBranchDir.get(0)).isFile());
		System.out.println("New File2: " + new File(expectedBaseProjectUriBranchDir.get(0)).isDirectory());

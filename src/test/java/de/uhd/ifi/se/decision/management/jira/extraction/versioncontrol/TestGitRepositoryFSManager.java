...
public class TestGitRepositoryFSManager {
	...
	// baseProjectUriDir.add(baseDir + File.separator + projectName + File.separator
	// + getHash(repoUris.get(0)));
	// baseProjectUriDefaultDir
	// .add(baseProjectUriDir.get(0) + File.separator +
	// folderForDefaultBranchNames.get(repoUris.get(0)));
	// baseProjectUriTempDir.add(baseProjectUriDir.get(0) + File.separator +
	// folderForTempBranchDirName);
	// expectedBaseProjectUriBranchDir.add(baseProjectUriDir.get(0) + File.separator
	// + getHash(branchName));
	// // init FS Manager
	// FSmanager = new GitRepositoryFSManager(baseDir, projectName, repoUris,
	// folderForDefaultBranchNames);
	// }
	//
	// @Test
	...
	//
	// String expectedFileName = baseProjectUriDir.get(0) + File.separator +
	...
	// assertEquals(baseProjectUriDefaultDir.get(0),
	// FSmanager.getDefaultBranchPath().get(repoUris.get(0)));
	// }
	//
	// @Test
	...
	// String expectedContentPath = expectedBaseProjectUriBranchDir.get(0) +
	// File.separator
	// + distinctFileInBranchFolder;
	//
	// assertEquals(0, findTemporaryDirectoryNames().length);
	// // test
	// testBranchFolderPreparation(branchName, expectedBaseProjectUriBranchDir,
	// expectedContentPath);
	// // preparation from branch directory itself should not affect temporary
	// folders
	// assertEquals(0, findTemporaryDirectoryNames().length);
	// }
	//
	// @Test
	// public void
	// testPrepareBranchDirectoryFromBranchPrecedenceOverDefaultAndTemp() {
	// // setup
	// addDistinctFileInBranchDir();
	// addDistinctFileInDefaultDir();
	...
	// }
	//
	// private void testBranchFolderPreparation(String branchName, List<String>
	// expectedDir, String expectedContentPath) {
	...
	// return DatatypeConverter.printHexBinary(digest).toUpperCase().substring(0,
	// 5);
	...
	// .list((current, name) -> (name.toString().startsWith("TEMP") && new

...
public class TestGitRepositoryFSManager {
	...
	for (String repoUri : getHashList(repoUris)) {
	    baseProjectUriDir.add(baseDir + File.separator + projectName + File.separator + repoUri);
	    baseProjectUriDefaultDir.add(baseProjectUriDir + File.separator + folderForDefaultBranchNames.get(repoUri));
	    baseProjectUriTempDir.add(baseProjectUriDir + File.separator + folderForTempBranchDirName);
	    expectedBaseProjectUriBranchDir.add(baseProjectUriDir + File.separator + getHash(branchName));
	}
	// init FS Manager

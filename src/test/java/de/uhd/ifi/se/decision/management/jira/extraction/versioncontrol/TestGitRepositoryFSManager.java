...
public class TestGitRepositoryFSManager {
	...
	private static final String distinctFileInDefaultFolder = "master.txt";
	...
	public void setUp() {
		...
		baseProjectUriDir = baseDir + File.separator + projectName + File.separator + getHash(TestSetUpGit.GIT_URI);
		baseProjectUriDefaultDir = baseProjectUriDir + File.separator + "master";
		baseProjectUriTempDir = baseProjectUriDir + File.separator + folderForTempBranchDirName;
		expectedBaseProjectUriBranchDir = baseProjectUriDir + File.separator + getHash(branchName);
		// init FS Manager
		fsManager = new GitRepositoryFSManager(baseDir, projectName, TestSetUpGit.GIT_URI, "master");
	}
	...
	public void testReleaseBranchDirectoryNameToTemp() {
		...
		String expectedFileName = baseProjectUriDir + File.separator + findTemporaryDirectoryNames()[0] + File.separator
	...
	public void testPrepareBranchDirectoryFromBranch() {
		...
		String expectedContentPath = expectedBaseProjectUriBranchDir + File.separator + distinctFileInBranchFolder;
	...
	public void testPrepareBranchDirectoryFromTemp() {
		// setup
		addDistinctFileInTempDir();
		String expectedContentPath = expectedBaseProjectUriBranchDir + File.separator + distinctFileInTempFolder;
	...
	public void testPrepareBranchDirectoryFromDefault() {
		// setup
		addDistinctFileInDefaultDir();
		String expectedContentPath = expectedBaseProjectUriBranchDir + File.separator + distinctFileInDefaultFolder;

/** 
 * Creates an indented outline (tree view) of decision knowledge elements and other knowledge elements 
 * (requirements, tasks, bug reports, ...) and enables to filter the tree of knowledge.
 *
 * Requires
 * conDecAPI
 * conDecObservable

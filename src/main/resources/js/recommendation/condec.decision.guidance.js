...
(function(global) {
	...
	function buildRecommendationTable(recommendations, parentElement) {
		...
		recommendations.forEach(recommendation => {
			...
			tableRow += "<td><div style='display:flex;gap:3px;align-items:center;'>" + recommendation.url + "<span class='aui-icon aui-icon-small " + recommendation.knowledgeSource.icon + "'>Knowledge Source Type</span></div></td>";

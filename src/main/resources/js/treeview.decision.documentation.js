		...
		content
				.insertAdjacentHTML(
						...
						'<p><label for="form-input-name" style="display:block;width:45%;float:left;">Summary:</label>'
								...
								+ '<input id="form-input-description" type="text" name="type" placeholder="Type in description" style="width:50%;"/></p>'
...
var contextMenuDeleteAction = {
	...
	'action' : function(node) {
		...
		content
				.insertAdjacentHTML(
						'afterBegin',
						'<p><input id="abort-submit" type="submit" value="Abort Action" style="float:right;"/>'
								+ '<input id="form-input-submit" type="submit" value="Delete this element" style="float:right;"/></p>');

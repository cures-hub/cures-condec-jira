...
public class BinaryClassifier extends AbstractClassifier {
	...
	public boolean loadFromFile() {
		return super.loadFromFile(DecisionKnowledgeClassifier.DEFAULT_DIR + BinaryClassifier.DEFAULT_MODEL_NAME);
	}

	@Override
	public void saveToFile() throws Exception {
		super.saveToFile(DecisionKnowledgeClassifier.DEFAULT_DIR + BinaryClassifier.DEFAULT_MODEL_NAME);
	}

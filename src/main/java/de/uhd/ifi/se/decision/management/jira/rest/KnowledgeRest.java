...
public interface KnowledgeRest {
     ...
     * @param documentationLocation of the {@link KnowledgeElement}, e.g. "i" for
     *                              Jira issue, see {@link DocumentationLocation}.
     * @param projectKey            of the Jira project, see
     ...
     * location "s").
     * 
     * @param request                                HttpServletRequest with an
     *                                               authorized Jira
     *                                               {@link ApplicationUser}.
     * @param element                                {@link KnowledgeElement} object
     *                                               with attributes, such as
     *                                               summary, description
     *                                               (optional),
     *                                               {@link DocumentationLocation},
     *                                               and {@link KnowledgeType}.
     * @param idOfExistingElement                    optional parameter. Identifier
     *                                               of a parent element that the
     *                                               new element should be linked
     *                                               with. Either the id or the key
     *                                               needs to be passed, not both.
     * @param documentationLocationOfExistingElement optional parameter.
     *                                               Documentation location of a
     *                                               parent element that the new
     *                                               element should be linked with.
     * @param keyOfExistingElement                   optional parameter. Key of a
     *                                               parent element that the new
     *                                               element should be linked with.
     *                                               Either the id or the key needs
     *                                               to be passed, not both.
    ...
    Response deleteDecisionKnowledgeElement(HttpServletRequest request, KnowledgeElement decisionKnowledgeElement);
    ...
    Response assignDecisionGroup(HttpServletRequest request, long sourceId, String location, String level,
	    String existingGroups, String addGroup, String projectKey);
}
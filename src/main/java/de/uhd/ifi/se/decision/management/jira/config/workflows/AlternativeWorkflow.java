...
public class AlternativeWorkflow {
	...
	public static String getXMLDescriptor() {
		return "<?xml version=\"1.0\" encoding=\"UTF-8\"?>\r\n"
				...
				+ "  <steps>\r\n"
				+ "    <step id=\"2\" name=\"Idea\">\r\n"
				+ "      <meta name=\"jira.status.id\">" + WorkflowXMLDescriptorProvider.getStatusId("Idea") + "</meta>\r\n"
				+ "      <actions>\r\n"
				...
				+ "      <meta name=\"jira.status.id\">" + WorkflowXMLDescriptorProvider.getStatusId("Discarded") + "</meta>\r\n"
				+ "      <actions>\r\n"

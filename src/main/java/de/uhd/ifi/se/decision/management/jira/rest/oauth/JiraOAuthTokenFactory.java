...
public class JiraOAuthTokenFactory {
	...
	/**
	 * Initialize JiraOAuthGetAccessToken by setting it to use POST method, secret,
	 * request token and setting consumer and private keys.
	 *
	 * @param tmpToken
	 *            request token
	 * @param secret
	 ...
	 */
	public JiraOAuthGetAccessToken getJiraOAuthGetAccessToken(String tmpToken, String secret, String consumerKey,
			String privateKey) throws NoSuchAlgorithmException, InvalidKeySpecException {
	...
	/**
	 * Initialize JiraOAuthGetTemporaryToken by setting it to use POST method, oob
	 * (Out of Band) callback and setting consumer and private keys.
	 *
	 * @param consumerKey
	 *            consumer key
	 * @param privateKey

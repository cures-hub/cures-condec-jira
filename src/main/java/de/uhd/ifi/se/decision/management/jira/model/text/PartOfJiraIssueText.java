 ...
 * text.
 */
public class PartOfJiraIssueText extends PartOfText {
	...
	public PartOfJiraIssueText(PartOfText partOfText, Comment comment) {
		this();
		if (comment != null) {
	...
	public PartOfJiraIssueText(Comment comment) {
	...
	public PartOfJiraIssueText(PartOfText partOfText, Issue jiraIssue) {

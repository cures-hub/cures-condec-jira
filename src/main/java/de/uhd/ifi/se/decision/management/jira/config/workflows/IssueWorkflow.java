...
public class IssueWorkflow {
	...
	public static String getXMLDescriptor() {
		return "<?xml version=\"1.0\" encoding=\"UTF-8\"?>\r\n"
				...
				+ "      <meta name=\"jira.status.id\">" + WorkflowXMLDescriptorProvider.getStatusId("Unresolved") + "</meta>\r\n"
				+ "      <actions>\r\n"
				...
				+ "      <meta name=\"jira.status.id\">" + WorkflowXMLDescriptorProvider.getStatusId("Resolved") + "</meta>\r\n"
				+ "      <actions>\r\n"

...
public enum QualityProblemType {
	...
	ISSUE_DOESNT_HAVE_DECISION("Issue does not have a valid decision!"), //
	ISSUE_DOESNT_HAVE_ALTERNATIVE("Issue does not have an alternative!"), //
	ISSUE_IS_UNRESOLVED("Issue is unresolved!"), //
	DECISION_DOESNT_HAVE_ISSUE("Decision does not have an issue!"), //
	...
	ALTERNATIVE_DOESNT_HAVE_ISSUE("Alternative does not have an issue!"), //

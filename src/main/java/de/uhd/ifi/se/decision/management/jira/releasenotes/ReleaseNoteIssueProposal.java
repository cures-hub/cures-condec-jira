...
/**
 * Interface Release Note Issue Proposal It saves the decision knowledge
...
public interface ReleaseNoteIssueProposal {
	...
	/**
	 * Gets the total count of resolved Jira issues of the Jira issue resolver and
	 * sets the experienceResolver criteria of the ReleaseNoteIssueProposal. The
	 * existing Resolver count HashMap is used to avoid duplicated equal JQL
	 * queries. The result may differ, depending of the logged-in user and his
	 * permissions.
	 * 
	 * @param issue
	 *            of the associated DecisionKnowledgeElement
